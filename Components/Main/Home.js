...
// import bgcolorimg from "../../assets/donation/bgcolorimg.jpg";
import img2 from "../../assets/donation/img2.webp";
...
const Home = () => {
    ...
    // ]
    const temp2 = [
        { title: "Registration", content: "This stage involves signing up as a blood donor, providing essential information such as personal details and medical history to ensure eligibility for blood donation.", img: g1 },
        { title: "Seeing", content: "During this phase, donors undergo a medical examination to assess their health and suitability for blood donation. This step ensures the safety of both the donor and the recipient.", img: g2 },
        { title: "Donation", content: "The core of the process where donors give blood voluntarily. Trained professionals collect the blood, which is then processed and stored for transfusion to patients in need, potentially saving lives.", img: g3 },
        { title: "Save Life", content: "After donation, the collected blood is used to support patients undergoing medical treatments, surgeries, or those with medical conditions requiring blood transfusions, ultimately contributing to saving lives within the community.", img: g4 },
    ];
    return (
        <div className="dark:text-white-900">
            <img src={img2} style={{maxWidth: '100%', height:'auto', objectFit:'cover'}} alt="" />
            ...
            <div className='w-full bg-blood text-white-900 h-max text-sm text-center font-bold'>
                <code>❤️ Connect us : savealife@gmail.com ❤️ || </code>
            </div>
        </div>
    )
}
